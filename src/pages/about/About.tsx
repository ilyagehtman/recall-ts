    ...
    <div className={ styles.applique }>
      ...
      <svg width="42" height="40" viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M26.0593 -1.74343e-05L12.4639 38.8307L15.1816 39.7793L28.777 0.948554L26.0593 -1.74343e-05Z"
              fill="#E0E2E5"/>
        <path d="M0.24548 23.0594L41.2407 19.588L40.9951 16.72L-0.000178346 20.1914L0.24548 23.0594Z"
              fill="#E0E2E5"/>
      </svg>
      <svg width="138" height="138" viewBox="0 0 138 138" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <svg width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.24597 6.3394L45.2412 2.86804L44.9956 3.85018e-05L4.00031 3.4714L4.24597 6.3394Z"
              fill="#E0E2E5"/>
        <path d="M1.03876 29.4942L39.4229 14.6847L38.3841 12.0001L5.90831e-06 26.8097L1.03876 29.4942Z"
              fill="#E0E2E5"/>
      </svg>
  ...
  return <div className={ styles.about }>
    ...
    <div className={ styles.title }>
      ...
      <span className="string centerString paragraphString">
        {
          'часто, чтобы сохранить воспоминание о моменте, мы забираем с собой и храним памятные предметы. это может быть что угодно:\n' +
